...
const handleRegister = (email, password) => console.log("REGISTER", email, password);
...
<template>
    ...
    <template v-if="isMobile">
      <div class="flex flex-col w-full max-w-md shadow-2xl rounded-xl overflow-hidden bg-white">
